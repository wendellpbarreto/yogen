...
var paths_admin = {
  scripts_src: 'public/assets@admin/scripts/src/**/*.js',
  scripts_dist: 'public/assets@admin/scripts',
  sass_src: 'public/assets@admin/styles/src/**/*.{scss,sass,css}',
  sass_dist: 'public/assets@admin/styles',
  sass_main: 'public/assets@admin/styles/src/main.scss',
};
...
gulp.task('sass', ['clean'], function () {
  gulp.src(paths.sass_main)
    ...
    .pipe(sass({style: 'compact', errLogToConsole: true, includePaths: ['public/assets/styles/src']}))
...
gulp.task('sass_admin', ['clean'], function () {
  gulp.src(paths_admin.sass_main)
    .pipe(sourcemaps.init())
    .pipe(sass({style: 'compact', errLogToConsole: true, includePaths: ['public/assets@admin/styles/src']}))
    .pipe(prefix("last 500 version"))
